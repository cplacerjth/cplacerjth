    ...
    async function carregarDados() {
      try {
        ...
        usuariosSnap.forEach((doc) => {
          const data = doc.data();
          if (data.tipo === 'vendedor') totalVendedores++;
          else if (data.tipo === 'cliente') totalClientes++;
        });
        ...
        setPedidosRecentes(pedidosLista.slice(0, 10));
      } catch (error) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm">Vendedores</p>
                <p className="text-2xl font-bold">{estatisticas.totalVendedores}</p>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Link href="/painel/admin/vendedores">
                  ...
                  <div className="flex justify-between items-center p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {pedido.clienteEmail || 'Cliente'} - {new Date(pedido.criadoEm).toLocaleDateString('pt-BR')}
                      </p>
                    </div>
